...
- Storefront access used during inspection: the supplied password (`1`). The password is intentionally **not** stored in this repository.
...
| `helix-header-implementation-prompt.md` | Full implementation prompt with the complete observation log, measurements, CSS behavior, Liquid schema, interaction states, and verification plan. |
